...
function Select({ ...properties }: ComponentProps<typeof SelectPrimitive.Root>) {
  return <SelectPrimitive.Root data-slot='select' {...properties} />;
}

function SelectGroup({ className, ...properties }: ComponentProps<typeof SelectPrimitive.Group>) {
  return (
...
function SelectValue({ ...properties }: ComponentProps<typeof SelectPrimitive.Value>) {
...
function SelectLabel({ className, ...properties }: ComponentProps<typeof SelectPrimitive.Label>) {
  return (
